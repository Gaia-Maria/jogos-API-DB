...
const addNewConsole = async (req, res) => {
    try {
    const { name, developer, releaseData, display, storageCapacities, numberOfPlayers, available, description } = req.body;
    const newConsole = new ConsolesModel({
        name, developer, releaseData, display, storageCapacities, numberOfPlayers, available, description 
    });
